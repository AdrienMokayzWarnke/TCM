...
public class Action {
    ...
    public static Action parse(String data) throws Exception {
        ...
        switch (str[0].trim()) {
            ...
            case "PASS":
                ...
                break;
            default:
                throw new Exception("Invalid action name. Should be SUMMON, ATTACK, or USE.");
        }
        ...
        if (type == Type.SUMMON) {
            try {
                ...
                throw new Exception("Invalid SUMMON argument. Expected integer (card id).");
            }
            ...
            try {
                ...
                throw new Exception("Invalid " + type.toString() + " arguments. Expected two integers (card id and target id).");
            }
    ...
    public String toStringNoText() {
        switch (type) {
            case SUMMON:
                return String.format("SUMMON %d;", arg1);
            case ATTACK:
    ...
    public String toString() {
        switch (type) {
            case SUMMON:
                return String.format("SUMMON %d %s;", arg1, text);
            case ATTACK:
